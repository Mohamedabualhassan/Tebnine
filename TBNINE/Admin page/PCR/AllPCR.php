...
<div id="viewport">
  ...
  <div id="sidebar">
    ...
    <ul class="nav">
      ...
      <li>
        <a href="/TBNINE/Admin page/PCR/AddnewPCR.php">
          <i class="zmdi zmdi-widgets"></i> ADD NEW PCR
        </a>
      </li>
    </ul>
  </div>
    ...
    <div class="content">
         ...
         <?php
                ...
                if($r)
                {
                    ...
                    <td><b>ID</b></td><td><b>FirstName</b></td><td><b>LastName</b></td><td><b>Date Of Birth</b></td><td><b>Phone Number<b/></td><td><b>Result</b></td>
                    </tr></thead>";
