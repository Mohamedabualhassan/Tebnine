...
<div id="viewport">
  ...
  <div id="sidebar">
    ...
    <ul class="nav">
      ...
      <li>
        <a href="/TBNINE/Admin page/VACC/AddnewVAC.php">
          <i class="zmdi zmdi-widgets"></i> ADD NEW VAC
        </a>
      </li>
      <li>
        <a href="/TBNINE/Admin page/VACC/NOVACC.php">
          <i class="zmdi zmdi-widgets"></i> NO VAC
        </a>
      </li>
  ...
  <div id="content">
    ...
    <div class="content">
                    <h1>List Of All Vaccinated People </h1><br>
         <?php

                include "connection.php";
                $q="Select * from vaccination where isvaccinated='yes'";
